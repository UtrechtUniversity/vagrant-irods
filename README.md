...
These scripts should support the 4.2.x iRODS versions that are available through the package repositories. As of 8 June 2021, versions 4.2.2 through 4.2.9 are available in the repositories.
