...
These scripts should support the 4.2.x iRODS versions that are available through the package repositories. As of 5 June 2020, versions 4.2.2 through 4.2.8 are available in the repositories.
